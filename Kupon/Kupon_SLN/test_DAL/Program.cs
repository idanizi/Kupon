...
namespace test_DAL
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Business business = new Business("1", "mega", "rishon", "lala", 12, "mega is the best", "shop", manager);
            Business business2 = new Business("2", "mega6", "beersheva", "rager", 166, "mega is the best", "shop", manager2);
